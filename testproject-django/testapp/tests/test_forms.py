...
from testapp.choices import ROLE_CHOICES
from testapp.validators import abc_validator, xyz_validator
...
SETTINGS_FIELDS = {
    ...
    'testapp.app_setting': forms.CharField,
    'testapp.setting_to_redefine': forms.IntegerField,
...
class TestForms(TestCase):
    ...
    def test_choice(self):
        ...
        field = \
            self.form.fields['CHOICE_SETTING_WITH_INTERNAL_MODEL_CHOICES']
        self.assertEqual(field.choices, list(ROLE_CHOICES))
    ...
    def test_field(self):
        form = self.form
        settings_counter = len(settings.available_settings) - 1 + \
                           len(settings.available_settings.testapp)
